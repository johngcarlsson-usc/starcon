...
fn portrait_path(variant: UltimateVariant) -> &'static str {
    match variant {
        ...
        // two races — keep our match arms keyed by the canon
        // `<code>` everywhere else but point to whatever PNG
        // they uploaded.
        UltimateVariant::Syreen => "ultimate/portrait_sypen.png",
        UltimateVariant::ZoqFotPik => "ultimate/portrait_zoqst.png",
...
fn variant_for_class(class: ShipClass) -> UltimateVariant {
    match class {
        ...
        // Tau fan ships have no canonical ultimate — use the harmless
        ...
        ShipClass::Neodr => UltimateVariant::Arilou,
        ShipClass::Iceco => UltimateVariant::Arilou,
        ShipClass::Leimu => UltimateVariant::Arilou,
        ShipClass::Uxjba => UltimateVariant::Arilou,
        ShipClass::Vioge => UltimateVariant::Arilou,
        ShipClass::Hubde => UltimateVariant::Arilou,
        ...
        ShipClass::Sclfr => UltimateVariant::Arilou,
        ...
        ShipClass::Arkpi => UltimateVariant::Arilou,
        ShipClass::Kolfl => UltimateVariant::Arilou,
    }
}
