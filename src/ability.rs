...
fn dispatch_primary(
    ...
    for (entity, ship, abilities, mut pos, rot, mut vel, mut cd, mut batt, mut crew, mmrxf_active, pkunk_clone, ai, invisible) in &mut q {        // While Mmrnmhrm's ultimate is active the tangled laser
